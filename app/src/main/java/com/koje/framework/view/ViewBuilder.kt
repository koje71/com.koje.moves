...
open class ViewBuilder(open val view: View) {
    ...
    fun getColorFromID(id: Int): Int {
        return view.resources.getColor(id, null)
    }
    ...
    fun getScreenWithDP(): Int {
        return (getScreenWithPX() / view.resources.displayMetrics.density).toInt()
    }
    ...
    fun setOnTouchListener(action: (v: View, event: MotionEvent) -> Boolean) {
